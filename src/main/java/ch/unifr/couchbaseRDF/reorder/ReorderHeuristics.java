package ch.unifr.couchbaseRDF.reorder;
...
public class ReorderHeuristics implements ReorderTransformation {
    ...
    static {
        ...
        matcher.addPattern(new Pattern(11,   VAR,  TERM, TERM, FILTERED)) ;    // ?PO
        matcher.addPattern(new Pattern(12,   VAR,  TERM, TERM)) ;    // ?PO
        
        matcher.addPattern(new Pattern(7,   TERM, TERM, VAR, FILTERED)) ;     // SP?
        matcher.addPattern(new Pattern(8,   TERM, TERM, VAR)) ;     // SP?
        
        matcher.addPattern(new Pattern(13,   VAR,  type, TERM, FILTERED)) ;
        matcher.addPattern(new Pattern(14,   VAR,  type, TERM)) ;   // ? type O -- worse than ?PO
        
        
        matcher.addPattern(new Pattern(18,  VAR,  VAR,  TERM, FILTERED)) ;    // ??O
        matcher.addPattern(new Pattern(20,  VAR,  VAR,  TERM)) ;    // ??O
        
        matcher.addPattern(new Pattern(9,  TERM, VAR,  VAR, FILTERED)) ;     // S??
